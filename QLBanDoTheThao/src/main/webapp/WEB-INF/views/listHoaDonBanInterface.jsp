	...
	<main class="container  ">
		...
		<div class="bg-light p-5 rounded">
			...
			<form class="d-inline-flex">
				<input name="searchHD" id="searchInputBH" class="form-control me-2"
				...
				<tbody id="table_products">
					<c:forEach items="${pagedListHolderBH.pageList}" var="sp">
						...
						<tr>
							...
							<td>${sp.makm}</td>
							<form>
								<td><input name="mahd" type="hidden" class="form-control"
									id="exampleFormControlInput1"
									placeholder="Vui lòng nhập tên sản phẩm" value="${sp.mahd}" />
